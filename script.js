...
\f0\fs24 \cf0 function parseCSV(csv) \{\
    ...
    modalCopyButton.forEach(button => \{\
      button.addEventListener('click', () => \{\
        ...
        if (button.classList.contains('modal-chat-button')) \{\
          alert('Now you can paste the prompt into your AI IDE, deeplinks to AI IDEs are coming soon (I hope)! \'97 IDE devs, please DM me!');\
        \}\
      \});\
    \});\
  \}\
